		...
		options = {
			{
				...
				action = function(entity)
					TriggerEvent('esx_mechanik:onHijackcar', entity)
				end,
				job = {['police'] = 0, ['mechanik'] = 0},
				distance = 3.0,
				num = 1
			},
			{
				...
				label = 'Napraw pojazd',
				action = function(entity)
					TriggerEvent('esx_mechanik:onFixkitFreecar', entity)
				end,
				job = {['police'] = 0, ['mechanik'] = 0},
				distance = 3.0,
				num = 2
			},
			{
				...
				action = function(entity)
					TriggerEvent('esx_police:odholuj', entity)
				end,
				job = {['police'] = 0, ['mechanik'] = 0},
				distance = 3.0,
				num = 3
			},
			{
				...
				label = 'Umyj pojazd',
				action = function(entity)
					TriggerEvent('esx_mechanik:cleanVehiclecar', entity)
				end,
				job = "mechanik",
				distance = 3.0,
				num = 4
